...
label start:
    ...
    show artem happy at left
    a "А давайте страшилки расскажем?"
    hide artem
    menu:
        "Поддержать идею":
            show me thinking at left
            i "Давайте, только не очень страшные..."
            hide me
            show max happy at left
            m "Отличная идея!"
            hide max
        "Отказаться":
            show me thinking at left
    ...
    "Но самое ужасное... это его рот. Он был грубо зашит толстыми черными нитками."
    ...
    "В правой руке он сжимал огромную хирургическую пилу."
        ...
        "Попробовать договориться с доктором":
            ...
            menu:
                ...
                "Продолжать уговаривать":
                    show me thinking at left
                    i "Клянусь! Мы просто хотим забрать друга и уйти!"
                    hide me
                    d "...Друг?.. Ха-ха... Я тоже... хочу друзей..."
                    "Пила в его руке блеснула. Пришлось действовать."
                    jump distract_doctor
...
label save_artem:
    ...
    hide me
    "Макс, не раздумывая, бросился вперед. Доктор занес пилу, но Макс оказался проворнее."
    ...
    "Макс выхватил пилу из руки ошеломленного доктора и со всей силы ткнул лезвие ему в бок."
...
label distract_doctor:
    ...
    "Я крикнул и бросился в противоположный от Артема угол. Доктор, хрипя, повернулся ко мне."

    show doctor scary:
        linear 1.0 xalign 0.2
    with dissolve

    "Этого момента хватило Максу. Пока доктор был ко мне спиной, Макс подкрался и выхватил пилу."
    ...
    "Он ткнул лезвие в спину безумца."
